   ...
   render() {
      return ( 
         ...
         < TopSongs 
            ...
            iTunesLink2 = { "http://www.itunes.com/" + this.state.result.name + '/' + ''}
            ...
            iTunesLink3 = { "http://www.itunes.com/" + this.state.result.name + '/' + ''}
            ...
            iTunesLink4 = { "http://www.itunes.com/" + this.state.result.name + '/' + ''}
            ...
            iTunesLink5 = { "http://www.itunes.com/" + this.state.result.name + '/' + ''}
